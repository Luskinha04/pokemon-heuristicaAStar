...
# Carrega os terrenos fixos
sprite_terrenos = {
    "G": pygame.image.load("sprites/grama.png"),
    "A": pygame.image.load("sprites/agua.png"),
    "M": pygame.image.load("sprites/montanha.png"),
    "C": pygame.image.load("sprites/caverna.png"),
}
...
def main():
    ...
    frame_lava = 0  # Inicializa o contador de frames da animação da lava
    ...
    while rodando:
        ...
        # Prioriza ginásio se ele estiver mais perto ou até 3 blocos mais longe
